...
public class GetRoomInfo {
	static final String url = Constant.URL+"getroominfo";
	static final String ROOMID = "roomid";
	
	private HttpClient client;
	private int roomid;
	
	public GetRoomInfo(HttpClient pClient, int pRoomId){
		this.client = pClient;
		this.roomid = pRoomId;
		new Thread(new GetRoomInfoRunnable()).start();
	}
	
	class GetRoomInfoRunnable implements Runnable{
		@Override
		public void run() {
